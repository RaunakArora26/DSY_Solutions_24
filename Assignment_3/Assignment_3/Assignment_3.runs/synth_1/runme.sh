...
HD_PWD='E:/DSY_SOLUTIONS/Assignment_3/Assignment_3/Assignment_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NOR_SM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NOR_SM.tcl
