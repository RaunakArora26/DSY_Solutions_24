...
HD_PWD='C:/Users/dell/Desktop/DSY_SOLUTIONS/Assignment_7/Assignment_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log J_k_FF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source J_k_FF.tcl
