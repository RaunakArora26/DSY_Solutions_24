...
HD_PWD='C:/Users/dell/Desktop/DSY_SOLUTIONS/Assignment_6/Assignment_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shannon_decom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shannon_decom.tcl
